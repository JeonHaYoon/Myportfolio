    ...
    public User selectUser(String id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                user.setDogname(rs.getString(3));
...
//        values ('asdf22', '1234', 'smith', 'aaa@aaa.com', '2022-01-01', 'facebook', now());
        ...
        try {
            ...
            pstmt.setString(3, user.getDogname());
...
//        PreparedStatement pstmt = null;
        ...
        String sql = "update user_info " +
                "set pswd = ?,  dogname=?, email =?, region=?, gender=? , reg_date=?" +
                "where id = ? ";
        ...
        try (
            ...
            pstmt.setString(1, user.getPswd());
            pstmt.setString(2, user.getDogname());
